    ...
    <section className="pt-2">
      ...
      <div className="mt-5 space-y-2.5 px-5">
        <p className="flex items-start gap-2.5 text-[13px] text-ink-600">
          <TrainFront className="mt-0.5 size-4 shrink-0 text-brand-500" />
          {t("subway")}
        </p>
        <p className="flex items-start gap-2.5 text-[13px] text-ink-600">
          <Plane className="mt-0.5 size-4 shrink-0 text-brand-500" />
          {t("airport")}
        </p>
      </div>
                ...
                <div className="flex flex-1 flex-col gap-2.5 p-4">
                  ...
                  <div className="mt-auto flex items-center justify-between gap-2 pt-1">
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 text-[13px] font-bold text-ink-800 transition hover:text-brand-700"
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1 rounded-full border border-brand-200 bg-brand-50 px-3 py-1.5 text-[12px] font-bold text-brand-700 transition hover:bg-brand-100"
                    >
                      {t("viewMap")}
